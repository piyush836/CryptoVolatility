...
if __name__ == '__main__':
    ...
    def predict(df):
        ...
        print(f"💡 Model: Naive Persistence\n")

    def serve():
        """Start Flask web server for multi-coin dashboard"""
    ...
    def main():
        ...
        parser.add_argument(
            ...
            default='full',
            help='Operation mode:\n'
                '  download - Download latest data from Yahoo Finance\n'
                '  full - Download + Engineer + Train + Predict (default)\n'
                '  predict - Just generate forecast\n'
                '  train - Just train models\n'
                '  serve - Start Flask web dashboard (http://localhost:5000)'
        )
